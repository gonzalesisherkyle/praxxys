...
<div class="card card-outline card-primary">
    ...
    <a href="../../index2.html" class="h1"><b>PRAXXYS</b></a>
    </div>
    <div class="card-body">
    ...
    <form action="{{ route('login') }}" method="POST">
        ...
        <input name="username" type="text" class="form-control @error('username') is-invalid @enderror" placeholder="Email or Username" value="{{ old('username') }}" required autofocus>
        @error('username')
